//+------------------------------------------------------------------+
//|                                   MQL5_Advisors_BollBreakout.mq5 |
//|                                                 Dmytro Malevskyi |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
...
//---
   ...
   if (isNewBar())
      {
         if ((close[1] > upperBandBuffer[1]) && (!longOpen))   // ---- go long
         {
            ZeroMemory(request);
         ...
         else if ((close[1] < lowerBandBuffer[1]) && (longOpen))  // ---- exit long
         {
            ZeroMemory(request);
         ...
         else if ((close[1] < lowerBandBuffer[1]) && (!shortOpen))   // ---- go short
         {
            ZeroMemory(request);
         ...
         else if ((close[1] < upperBandBuffer[1]) && (shortOpen)) // ---- exit short
         {
            ZeroMemory(request);
            ulong ticket = PositionGetTicket(0);
            request.type = ORDER_TYPE_BUY;
